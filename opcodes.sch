`((unreachable . (() . "\x00"))
  ...
  (local.set  . ((,localidx) . "\x21"))
  (global.get . ((,globalidx) . "\x23"))
  (global.set . ((,globalidx) . "\x24"))
  ...
  (struct.new_default . ((,typeidx) . "\xFB\x01"))

  (struct.get_s       . ((,typeidx ,fieldidx) . "\xFB\x03"))
  (struct.get_u       . ((,typeidx ,fieldidx) . "\xFB\x04"))
  (struct.set         . ((,typeidx ,fieldidx) . "\xFB\x05"))
  (array.new          . ((,typeidx) . "\xFB\x06"))

  (array.new_default  . ((,typeidx) . "\xFB\x07"))
  (array.new_fixed    . ((,typeidx ,u32) . "\xFB\x08"))
  (array.new_data     . ((,typeidx ,dataidx) . "\xFB\x09"))
  (array.get_s        . ((,typeidx) . "\xFB\x0C"))
  (array.get_u        . ((,typeidx) . "\xFB\x0D"))
  (array.set          . ((,typeidx) . "\xFB\x0E"))
  (array.len          . (() . "\xFB\x0F"))
