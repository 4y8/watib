...
\begin{abstract}
  ...
  \textsf{watib}'s optimisation passes showing that they do not impact most
  Scheme programs except for two tests that got a noticeable improvement. We end
  by presenting a promising work-in-progress adaptation of Static Basic Block
  Versioning to Wasm.
\end{abstract}
...
phase as it is a straightforward transcription of the interlediate
representation into the format binary of the specification.
...
a respective speedup of 17\% and 10\%.
