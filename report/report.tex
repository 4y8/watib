...
Absence of a goto instruction complexifies the translation of a CFG to a valid
...
of~\cite{cooper2001simple}. We adaptated Ramsey's algorithm to support
...
the loops is belongs to. This allows forbidding jumping inside a loop from a
basic block outside the loop (unless the destination is the loop head).
...
not sufficient to impact most code produced by Bigloo. To adress this issue, we
ended by presenting our on-going implementation of SBBV for Wasm.
