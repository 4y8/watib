...
We are investigating the reasons of the slowdown on \texttt{conform}. Disabling
the Type-Dependent Control Flow Rewriting pass removes the performance penalty.
We are looking for heuristics to guide the application of transformation.
