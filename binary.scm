             ...
             (let* ((t (remove-names-subtype st))
                ...
                (match-case st
                   ((or (sub final ??- (struct . ?fds))
                    ...
                    ;;;;; quick hack
                    (hashtable-put! fieldtypes name (get-fields fds)))
